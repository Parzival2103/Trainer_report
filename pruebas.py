...
class Eficiencia:
    ...
    def __init__(self, window):
        ...
        Entry(self.wind, justify="center", textvariable=self.TE2, width="5").place(x=115, y=55)

        self.CE2label = Label(self.wind, text="Componente Extra")
        self.CE2label.place(x=155, y=55)
        self.CE2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.CE2, width="5").place(x=265, y=55)

        self.Hora2label = Label(self.wind, text="Hora o 1/2 Hora")
        self.Hora2label.place(x=305, y=55)
        self.Hora2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.HR2, width="5").place(x=405, y=55)
        ...
        self.Meta2label.place(x=105, y=145)
        self.Meta2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.Meta2, state="disabled", width="5").place(x=145, y=145)

        self.UPHT2label = Label(self.wind, text="Total de unidades producidas")
        self.UPHT2label.place(x=205, y=145)
        self.UPHT2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.UPHT2, state="disabled", width="5").place(x=375, y=145)

        self.PR2label = Label(self.wind, text="Porcentaje de unidades producidas")
        self.PR2label.place(x=415, y=145)
        self.PR2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.PR2, state="disabled", width="5").place(x=615, y=145)

        self.PJ2label = Label(self.wind, text="Porcentaje de Unidades Justificadas")
        self.PJ2label.place(x=15, y=185)
        self.PJ2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.PJ2, state="disabled", width="5").place(x=215, y=185)

        self.MP2label = Label(self.wind, text="Minutos Perdidos")
        self.MP2label.place(x=255, y=185)
        self.MP2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.MP2, state="disabled", width="5").place(x=365, y=185)

        self.UP2label = Label(self.wind, text="Unidades Perdidas")
        self.UP2label.place(x=415, y=185)
        self.UP2label.config(bg="blanchedalmond", fg="black")
        Entry(self.wind, justify="center", textvariable=self.UP2, state="disabled", width="5").place(x=525, y=185)

        self.resultadosboton2 = Button(self.wind, text="RESULTADOS", command=resultados2)
        self.resultadosboton2.place(x=15, y=295)
    ...
    def delete_product(self):
        ...
        query = 'DELETE FROM BRANDON WHERE Hora = ?'
